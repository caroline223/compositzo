...
import EntryInfo from './entries_page_components/EntryInfo'
        ...
        <div>
           <Menu id='journalMenu' >
                ...
                <Menu.Menu position='right'>
                    <Dropdown item text="Name" setUser={setUser} style={{color: 'white', fontWeight: 'bold'}}>
                        <Dropdown.Menu>
              ...
              <div style={{backgroundColor: 'gainsboro', textAlign: 'center'}}>
                            <div className="ui search searchBar" >
                                <div className="ui icon input" >
                                    <input onChange={searchEntries} placeholder="Search Title" className="prompt"  />
